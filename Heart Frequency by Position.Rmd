...
```{r}
p <- ggplot(data[data$lap > 1 & data$lap < 8,]) +
...
write.csv(data, paste0(output.dir, "Heart Frequency by Position.csv"), row.names = FALSE)
write.plot(p, paste0(output.dir, "Heart Frequency by Position.png"))
```
